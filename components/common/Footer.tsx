    ...
    <FooterContainer>
      <WhiteBackground>
        <FooterContents>
          ...
          <Link data-testid="githubSVGLink" target="_blank" href="mailto:turtle601@naver.com" passHref>
            <SVGLink href="replace">
          ...
          <Link data-testid="githubSVGLink" target="_blank" href="https://github.com/turtle601" passHref>
            <SVGLink href="replace">
